// Alternative Vercel Serverless Function: /api/logs.js
// Handles both /api/logs and /api/logs/activity via query parameter
// This is a flat structure approach that Vercel handles better
...
module.exports = (req, res) => {
  ...
  // Check if this is the activity endpoint
  const path = req.url || '';
  const isActivityEndpoint = path.includes('/activity') || req.query.endpoint === 'activity';

  if (!isActivityEndpoint && !path.includes('/logs')) {
